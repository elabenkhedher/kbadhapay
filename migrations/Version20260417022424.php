 ...
 */
final class Version20260417022424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE infraction (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_infraction VARCHAR(255) NOT NULL, montant_amende NUMERIC(10, 3) NOT NULL, lieu VARCHAR(255) NOT NULL, plaque_immat VARCHAR(20) NOT NULL, date_infraction DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, notes CLOB DEFAULT NULL, user_id INTEGER DEFAULT NULL, agent_id INTEGER DEFAULT NULL, CONSTRAINT FK_C1A458F5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C1A458F53414710B FOREIGN KEY (agent_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
