 ...
 */
final class Version20260420215337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN id_document_path VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN passport_path VARCHAR(255) DEFAULT NULL');
    }
